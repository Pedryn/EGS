    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.button} onPress={() => router.push('/pagesSustentabilidade/artigos')}>
                    <Text style={styles.linkText}>Artigos</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button} onPress={() => router.push('/pagesSustentabilidade/importanciaSustentabilidade')}>
                    <Text style={styles.linkText}>Importância da Sustentabilidade</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button} onPress={() => router.push('/pagesSustentabilidade/dicas')}>
